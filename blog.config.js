...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '24f2cd142ee2804894e9ec8e2c226fd3',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SSIng2011', // 您的昵称 例如 张三
  BIO: process.env.NEXT_PUBLIC_BIO || 'Sailing Singer 2011', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blognews.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blognews,web building', // 网站关键词 英文逗号隔开
